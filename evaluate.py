...
def train_celebvhq(args, config):
    ...
    if finetune:
        ...
        model = Classifier(
            num_classes, config["backbone"], True, args.STEM-DFER_ckpt, "multilabel", config["learning_rate"],
            args.n_gpus > 1,
        )
...
if __name__ == '__main__':
    ...
    parser.add_argument("--STEM-DFER_ckpt", type=str, default=None,
        help="Path to STEM-DFER checkpoint. Default: None, load from online.")
